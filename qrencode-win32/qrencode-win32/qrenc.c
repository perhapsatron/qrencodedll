...
static const struct option options[] = {
	...
	{_T("output")       , required_argument, NULL, 'o'},
	{_T("level")        , required_argument, NULL, 'l'},
	{_T("size")         , required_argument, NULL, 's'},
	{_T("symversion")   , required_argument, NULL, 'v'},
	{_T("margin")       , required_argument, NULL, 'm'},
	{_T("dpi")          , required_argument, NULL, 'd'},
	{_T("type")         , required_argument, NULL, 't'},
	{_T("structured")   , no_argument      , NULL, 'S'},
	{_T("kanji")        , no_argument      , NULL, 'k'},
	{_T("casesensitive"), no_argument      , NULL, 'c'},
	{_T("ignorecase")   , no_argument      , NULL, 'i'},
	{_T("8bit")         , no_argument      , NULL, '8'},
	{_T("micro")        , no_argument      , NULL, 'M'},
	{_T("foreground")	, required_argument, NULL, 'f'},
	{_T("background")	, required_argument, NULL, 'b'},
	{_T("version")      , no_argument      , NULL, 'V'},
	{NULL, 0, NULL, 0}
};

static TCHAR *optstring = _T("ho:l:s:v:m:d:t:Skci8MV");
